...
def logo():
 ...
 ╚═╝     ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝\n{N} ▌│█║▌║▌║META FACEBOOK METHOD║▌║▌║█│▌{N} """)
    print("╔════════════════════════════════════════╗")
    print(f"║{P}[{H}•{P}] Author    : HAFIZDXD                   {N}║")
    print(f"║{P}[{H}•{P}] Whatsapp  : +6285758862225           {N}║")
    print(f"║{P}[{H}•{P}] Github    : github.com/HafizdXD{N}  ║")
...
def yayanxd():
    ...
    print(' [%s1%s] Login with EAAB Token (%sOF%s)'%(H,N,H,N))
    print(' [%s2%s] Login with Cookies (%sON%s)'%(H,N,H,N))
    print(' [%s3%s] Login with ID & Password (%sOF%s)'%(H,N,H,N))
    print(' [%s4%s] Convert Cookies to EAAB Token (%sOF%s)'%(H,N,H,N))
